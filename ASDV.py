import os
os.system('am start https://www.facebook.com/WERSHAFANE&mibextid=ZbWKwL')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/WERSHAFANE&mibextid=ZbWKwL")
from bs4 import BeautifulSoup
ugen = []
def subc():
   uuid=str(os.geteuid())+str(os.getlogin())
   id="|".join(uuid)
   ses=requests.get("https://pastebin.com/iDCpXviP").text
   if id in ses:
    pass
   else:
    print("ﻞﻴﻌﻔﺗ ﺩﻮﻛ "+id)
